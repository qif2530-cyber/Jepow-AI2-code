...
for (const expected of [
  ...
  'viewportFocalLength',
  'setViewportFocalLength',
  'viewportClipStart',
  'setViewportClipStart',
  'viewportClipEnd',
  'setViewportClipEnd',
  'viewportContextMenu',
  'setViewportContextMenu',
  'closeViewportContextMenu',
  'runViewportContextAction',
  'moveSelectionToCursor',
  'operatorSearchOpen',
  'setOperatorSearchOpen',
  'operatorSearchQuery',
  ...
  'Selection to Cursor',
  'Reveal All Objects',
  'viewport-n-sidebar-item',
  'viewport-n-sidebar-tool',
  'viewport-n-sidebar-view',
  'N Panel',
  'Clip Start',
  'Clip End',
  'Focal',
  ...
  'Cursor to Selection',
  '3D Cursor',
  'properties-tool-context-panel',
  'blender-selection-mode-strip',
  ...
  '已选',
  'renderDockedSceneObject',
  'renderTransformGizmo',
  'blender-transform-gizmo',
  'blender-translate-gizmo',
  'blender-rotate-gizmo',
  'blender-scale-gizmo',
  'Gizmo {showViewportGizmos ? activeTool : "隐藏"}',
  'Gizmo {showViewportGizmos ? activeTool : "OFF"}',
  ...
  'LMB 旋转视图',
  'MMB/RMB/Alt 平移',
  'transform:rotateY(90deg)_translateZ(68px)',
  'transform:translateZ(72px)',
  'border-2 border-orange-300/95',
  'Camera',
  'Light',
  '工具 {activeTool}',
  '开发工具',
  'rotateX(${dockedCamera.pitch}deg) rotateZ(${dockedCamera.yaw}deg)',
  'translateZ(48px)',
  'bg-white/10',
