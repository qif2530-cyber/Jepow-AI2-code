...
const UI_RUNTIME_CAPABILITIES = Object.freeze([
  ...
  'full-scene-docked-object-rendering',
  'transform-properties-panel',
  'docked-scene-object-picking',
  'blender-style-application-shell',
  'workspace-tab-strip',
  'outliner-properties-sidebar',
  'timeline-dopesheet-strip',
  'viewport-header-overlay-gizmo-shading-controls',
  'outliner-search-visibility-lock-controls',
  'properties-collapsible-sections',
  'material-physics-render-property-panels',
  'editable-material-base-color',
  'physics-property-actions',
  'render-shading-property-controls',
  'mode-aware-selection-tool-settings',
  'axis-constraint-proportional-editing-controls',
  'editor-status-feedback-bar',
  'stateful-workspace-tabs',
  'stateful-properties-editor-tabs',
  'viewport-quick-add-scene-stats',
  'menu-backed-operator-search',
  'timeline-frame-controls',
  'three-d-cursor-tool-and-marker',
  'editable-three-d-cursor-coordinates',
  'grid-axis-space-labels',
  'tool-aware-transform-gizmo',
  'gizmo-mode-status-feedback',
  'viewport-n-sidebar-panels',
  'default-collapsed-n-sidebar',
  'viewport-view-parameter-controls',
  'viewport-object-context-menu',
  'context-menu-cursor-selection-actions',
  'operator-search-command-palette',
  'f3-operator-search-hotkey',
]);
